...
ELEMENT_RESULTS = {
    'ISTJ': {
        ...
        'imageUrl': 'https://loremflickr.com/1000/1000/iron,construction', 'usage': '건축 구조물 및 강철 생산',
        'bestMatch': {'mbti': 'ESFP', 'element': '구리', 'reason': '철의 견고한 구조와 구리의 뛰어난 전도성이 만나 인프라 구축의 완벽한 파트너가 됩니다.'}, 
        'worstMatch': {'mbti': 'ENFP', 'element': '산소', 'reason': '철이 산소를 만나면 산화(부식)되어 구조가 약해지듯, 서로의 본질을 갉아먹을 수 있습니다.'}
    },
    'ISFJ': {
        ...
        'imageUrl': 'https://loremflickr.com/1000/1000/gold,bars', 'usage': '장신구 및 화폐 가치 저장',
        'bestMatch': {'mbti': 'ESTP', 'element': '나트륨', 'reason': '금의 변치 않는 가치가 나트륨의 폭발적인 에너지를 안정적으로 감싸주어 상호 보완적인 관계가 됩니다.'}, 
        'worstMatch': {'mbti': 'ENTP', 'element': '인', 'reason': '안정을 추구하는 금의 성질이 끊임없이 연소하고 변화하는 인의 변덕스러움을 견디기 힘들어합니다.'}
    },
    'INFJ': {
        ...
        'imageUrl': 'https://loremflickr.com/1000/1000/platinum,jewelry', 'usage': '자동차 촉매 장치 및 고급 정밀 기기',
        'bestMatch': {'mbti': 'ENFP', 'element': '산소', 'reason': '백금 촉매가 산소 반응을 이끌어 에너지를 만들듯, 서로의 잠재력을 폭발시키는 최고의 촉매제가 됩니다.'}, 
        'worstMatch': {'mbti': 'ESTP', 'element': '나트륨', 'reason': '고귀하고 정교한 백금의 성질이 나트륨의 거칠고 즉흥적인 반응성과는 조화를 이루기 어렵습니다.'}
    },
    'INTJ': {
        ...
        'imageUrl': 'https://loremflickr.com/1000/1000/carbon,diamond', 'usage': '다이아몬드, 연필심, 탄소 섬유',
        'bestMatch': {'mbti': 'ENTP', 'element': '인', 'reason': '탄소와 인이 생명체의 DNA 뼈대를 이루듯, 두 유형은 지적 결합을 통해 거대한 시스템을 설계합니다.'}, 
        'worstMatch': {'mbti': 'ESFP', 'element': '구리', 'reason': '독립적이고 견고한 탄소의 논리가 사교적이고 감각적인 구리의 에너지를 소음으로 느낄 수 있습니다.'}
    },
    'ISTP': {
        ...
        'imageUrl': 'https://loremflickr.com/1000/1000/titanium,aerospace', 'usage': '항공우주 부품 및 인공 관절',
        'bestMatch': {'mbti': 'ESFJ', 'element': '알루미늄', 'reason': '티타늄의 강도와 알루미늄의 가벼움이 만나 항공우주 산업의 가장 완벽한 합금을 만들어냅니다.'}, 
        'worstMatch': {'mbti': 'ENFJ', 'element': '수소', 'reason': '수소가 티타늄 내부로 침투해 취성(깨짐)을 유발하듯, 감정적 과잉이 냉철한 판단을 흐릴 수 있습니다.'}
    },
    'ISFP': {
        ...
        'imageUrl': 'https://loremflickr.com/1000/1000/silver,jewelry', 'usage': '거울 코팅, 은식기, 전자 회로',
        'bestMatch': {'mbti': 'ESTJ', 'element': '칼슘', 'reason': '은의 섬세한 빛이 칼슘의 견고한 골조와 만나 아름다우면서도 실용적인 구조를 완성합니다.'}, 
        'worstMatch': {'mbti': 'ENTJ', 'element': '우라늄', 'reason': '우라늄의 강력한 방사선이 은의 순수한 광택을 변색시키듯, 강한 압박감이 예술적 영혼을 위축시킵니다.'}
    },
    'INFP': {
        ...
        'imageUrl': 'https://loremflickr.com/1000/1000/neon,lights,night', 'usage': '네온 사인 및 고전압 표시기',
        'bestMatch': {'mbti': 'ENTJ', 'element': '우라늄', 'reason': '우라늄의 거대한 에너지가 네온을 밝게 빛나게 하듯, 서로의 열정이 만나 세상을 환하게 밝힙니다.'}, 
        'worstMatch': {'mbti': 'ESTJ', 'element': '칼슘', 'reason': '자유로운 기체인 네온이 단단한 칼슘의 틀 안에서 답답함을 느끼듯, 엄격한 규칙이 창의성을 억압합니다.'}
    },
    'INTP': {
        ...
        'imageUrl': 'https://loremflickr.com/1000/1000/colorful,balloons', 'usage': '풍선 충전재 및 MRI 냉각제',
        'bestMatch': {'mbti': 'ENFJ', 'element': '수소', 'reason': '수소와 헬륨이 별의 중심에서 핵융합을 하듯, 두 유형은 인류를 위한 거대한 에너지를 창출합니다.'}, 
        'worstMatch': {'mbti': 'ESFJ', 'element': '알루미늄', 'reason': '가볍게 떠다니는 헬륨의 사고방식이 알루미늄의 지극히 현실적이고 실용적인 세계관과 충돌합니다.'}
    },
    'ESTP': {
        ...
        'imageUrl': 'https://loremflickr.com/1000/1000/salt,crystals', 'usage': '식탁용 소금 및 가로등',
    ...
    'ESFP': {
        ...
        'imageUrl': 'https://loremflickr.com/1000/1000/copper,wire', 'usage': '전선, 배관, 동전 생산',
        'bestMatch': {'mbti': 'ISTJ', 'element': '철', 'reason': '구리의 뛰어난 전도성과 철의 견고한 지지력이 만나 실용적이면서도 강력한 파트너십을 이룹니다.'}, 
    ...
    'ENFP': {
        ...
        'imageUrl': 'https://loremflickr.com/1000/1000/scuba,diving', 'usage': '의료용 산소 및 로켓 연료',
    ...
    'ENTP': {
        ...
        'imageUrl': 'https://loremflickr.com/1000/1000/phosphorus,matches', 'usage': '성냥, 비료, 세제 성분',
    ...
    'ESTJ': {
        ...
        'imageUrl': 'https://loremflickr.com/1000/1000/calcium,milk', 'usage': '뼈와 치아 형성, 시멘트 제조',
    ...
    'ESFJ': {
        ...
        'imageUrl': 'https://loremflickr.com/1000/1000/aluminum,foil', 'usage': '음료 캔, 주방용 호일, 운송 수단 부품',
    ...
    'ENFJ': {
        ...
        'imageUrl': 'https://loremflickr.com/1000/1000/rocket,launch', 'usage': '청정 연료 전지 및 로켓 추진제',
    ...
    'ENTJ': {
        ...
        'imageUrl': 'https://loremflickr.com/1000/1000/nuclear,power,plant', 'usage': '원자력 발전 및 방사선 연대 측정',
