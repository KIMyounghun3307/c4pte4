...
ELEMENT_RESULTS = {
    'ISTJ': {
        ...
        'imageUrl': 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&q=80&w=800', 'usage': '건축 구조물 및 강철 생산',
    ...
    'ISFJ': {
        ...
        'imageUrl': 'https://images.unsplash.com/photo-1589182373726-e4f658ab50f0?auto=format&fit=crop&q=80&w=800', 'usage': '장신구 및 화폐 가치 저장',
    ...
    'INFJ': {
        ...
        'imageUrl': 'https://images.unsplash.com/photo-1615486511484-92e172cc4fe0?auto=format&fit=crop&q=80&w=800', 'usage': '자동차 촉매 장치 및 고급 정밀 기기',
    ...
    'INTJ': {
        ...
        'imageUrl': 'https://images.unsplash.com/photo-1512161775974-407f68c55b72?auto=format&fit=crop&q=80&w=800', 'usage': '다이아몬드, 연필심, 탄소 섬유',
    ...
    'ISTP': {
        ...
        'imageUrl': 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&q=80&w=800', 'usage': '항공우주 부품 및 인공 관절',
    ...
    'ISFP': {
        ...
        'imageUrl': 'https://images.unsplash.com/photo-1533418264835-98fe1e30c64e?auto=format&fit=crop&q=80&w=800', 'usage': '거울 코팅, 은식기, 전자 회로',
    ...
    'INFP': {
        ...
        'imageUrl': 'https://images.unsplash.com/photo-1550684848-fac1c5b4e853?auto=format&fit=crop&q=80&w=800', 'usage': '네온 사인 및 고전압 표시기',
    ...
    'INTP': {
        ...
        'imageUrl': 'https://images.unsplash.com/photo-1531346878377-a5be20888e57?auto=format&fit=crop&q=80&w=800', 'usage': '풍선 충전재 및 MRI 냉각제',
    ...
    'ESTP': {
        ...
        'imageUrl': 'https://images.unsplash.com/photo-1518110168401-f28bf39c4a44?auto=format&fit=crop&q=80&w=800', 'usage': '식탁용 소금 및 가로등',
    ...
    'ESFP': {
        ...
        'imageUrl': 'https://images.unsplash.com/photo-1624365169192-6f17be3a760d?auto=format&fit=crop&q=80&w=800', 'usage': '전선, 배관, 동전 생산',
    ...
    'ENFP': {
        ...
        'imageUrl': 'https://images.unsplash.com/photo-1530026405186-ed1f139313f8?auto=format&fit=crop&q=80&w=800', 'usage': '의료용 산소 및 로켓 연료',
    ...
    'ENTP': {
        ...
        'imageUrl': 'https://images.unsplash.com/photo-1536939459926-301728717817?auto=format&fit=crop&q=80&w=800', 'usage': '성냥, 비료, 세제 성분',
    ...
    'ESTJ': {
        ...
        'imageUrl': 'https://images.unsplash.com/photo-1550583724-b2692b85b150?auto=format&fit=crop&q=80&w=800', 'usage': '뼈와 치아 형성, 시멘트 제조',
    ...
    'ESFJ': {
        ...
        'imageUrl': 'https://images.unsplash.com/photo-1584013321683-f824c6ed195f?auto=format&fit=crop&q=80&w=800', 'usage': '음료 캔, 호일, 운송 수단',
    ...
    'ENFJ': {
        ...
        'imageUrl': 'https://images.unsplash.com/photo-1614728263952-84ea256f9679?auto=format&fit=crop&q=80&w=800', 'usage': '청정 연료 및 로켓 추진제',
    ...
    'ENTJ': {
        ...
        'imageUrl': 'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&q=80&w=800', 'usage': '원자력 발전 및 연대 측정',
